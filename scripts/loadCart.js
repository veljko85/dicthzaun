      ...
      return this.each(function () {
        ...
        priceBut.onclick = () => {
          if (cartPricesLoaded[0]) {
            ...
            let dich180180GrunCart = 0;
            let dich180150GrunCart = 0;
            let dich150180GrunCart = 0;
            let dich18090GrunCart = 0;
            let dich120180GrunCart = 0;
            let dich90180GrunCart = 0;
            let dich60180GrunCart = 0;
            let dichKosaGrunCart = 0;
            let dich180120GrunCart = 0;

            let dich180180GrauCart = 0;
            let dich18090GrauCart = 0;
            let dich90180GrauCart = 0;
            let dichKosaGrauCart = 0;

            for (let i = 0; i < allFences.length; i++) {
              if (fencesArr[i].color == "grun") {
                if (allFences[i][0].isVisible) dich180180GrunCart += 1;
                if (allFences[i][1].isVisible) dich180150GrunCart += 1;
                if (allFences[i][2].isVisible) dich150180GrunCart += 1;
                if (allFences[i][3].isVisible) dich18090GrunCart += 1;
                if (allFences[i][4].isVisible) dich120180GrunCart += 1;
                if (allFences[i][5].isVisible) dich90180GrunCart += 1;
                if (allFences[i][6].isVisible) dich60180GrunCart += 1;
                if (allFences[i][7].isVisible || allFences[i][8].isVisible)
                  dichKosaGrunCart += 1;
                if (allFences[i][9].isVisible) dich180120GrunCart += 1;
              }
              if (fencesArr[i].color == "grau") {
                if (allFences[i][0].isVisible) dich180180GrauCart += 1;
                if (allFences[i][3].isVisible) dich18090GrauCart += 1;
                if (allFences[i][5].isVisible) dich90180GrauCart += 1;
                if (allFences[i][7].isVisible || allFences[i][8].isVisible)
                  dichKosaGrauCart += 1;
              }
            }
            ...
            let woodenPost190Grun = 0;
            let woodenPost95Grun = 0;
